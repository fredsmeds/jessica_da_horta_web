const pt = {
  ...
  about: {
    ...
    careerText: [
      'Em 2015 comecei os primeiros estágios numa empresa de jardinagem. Foi aí que percebi a distância entre o mundo académico e a realidade: os custos, a logística, o comportamento das plantas fora dos livros. Mais tarde trabalhei num atelier de consultoria ambiental, onde participei em concursos nacionais e aprendi a trabalhar a uma escala maior.',
      'Voltei à jardinagem com novas camadas de experiência e com uma certeza cada vez mais nítida: gosto de estar próxima das plantas e das equipas. Gosto desta dualidade entre o desenho e a instalação, entre o projeto e o campo.',
      'Ao longo deste percurso fui questionando uma tendência dominante na horticultura: tratar as plantas como produto descartável, mantidas artificialmente com sistemas de rega e fertilizantes, desligadas do seu ecossistema. Comecei a orientar o meu trabalho para jardins de clima mediterrânico — espécies adaptadas, resilientes, que se estabelecem e vivem com os recursos naturais do local.',
    ],
    ...
    pressTitle: 'Imprensa',
    pressPlaceholder: 'Cobertura mediática em breve.',
    certTitle: 'Certificações e Formação',
    certPlaceholder: 'Certificações em breve.',
    workshopsTitle: 'Workshops e Eventos',
    workshopsPlaceholder: 'Calendário de workshops em breve.',
  ...
  contact: {
    ...
    // Jobs form
    jobsTitle: 'Candidatura — Prestador de Serviços',
    jobsIntro: 'Trabalhamos com jardineiros independentes em regime de recibo verde. Preencha o formulário com as suas informações e documentação.',
    jobsNameLabel: 'Nome completo',
    jobsAgeLabel: 'Data de Nascimento',
    jobsNationalityLabel: 'Nacionalidade',
    jobsIdLabel: 'Número de BI / Cartão de Cidadão',
    jobsNifLabel: 'NIF (Número de Identificação Fiscal)',
    jobsIbanLabel: 'IBAN',
    jobsPhoneLabel: 'Telefone',
    jobsEmailLabel: 'Email',
    jobsExperienceLabel: 'Experiência profissional',
    jobsExperiencePlaceholder: 'Descreva a sua experiência em jardinagem, espécies com que trabalhou, equipamentos, etc.',
    jobsAvailabilityLabel: 'Disponibilidade',
    jobsAvailabilityPlaceholder: 'Ex: Segunda a Sexta, a tempo inteiro / fins de semana / etc.',
    jobsDownloadBtn: 'Descarregar Candidatura (CSV)',
    jobsNote: 'A candidatura será guardada em formato CSV para processamento interno. Os seus dados serão tratados de acordo com a nossa Política de Privacidade.',
  },
