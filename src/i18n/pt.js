const pt = {
  ...
  about: {
    ...
    careerItems: [
      {
        ...
        location: 'Sintra',
        desc: 'Projeto e acompanhamento de jardins residenciais mediterrânicos.',
      },
      {
        role: 'Arquiteta Paisagista',
        org: 'AJ Manata Jardins',
        period: 'Mai 2017 – Ago 2022',
        location: 'Sintra',
        desc: 'Cinco anos numa empresa de referência — design, instalação e acompanhamento de jardins residenciais e comerciais.',
      },
      {
        role: 'Colaboradora Freelancer',
        org: 'EPCA',
        period: 'Mar 2016 – Jun 2016',
        location: 'Telheiras',
        desc: 'Concursos públicos de arquitetura paisagista: Águeda (40 ha) e Castelo Branco (21 ha).',
      },
      {
        role: 'Estagiária',
        org: 'AJ Manata Jardins',
        period: 'Mai 2014 – Set 2014',
        location: 'Galamares, Sintra',
        desc: 'Primeiro contacto com o terreno — projeto e instalação de jardins residenciais.',
      },
    ],
    ...
    pressItems: [
      ...
      { type: 'article', title: 'Criar um Jardim de Sequeiro Mediterrânico: Passos e Princípios', outlet: 'Revista APH, Nº 141', year: '2021', url: 'https://www.linkedin.com/pulse/artigo-sobre-como-criar-um-jardim-de-sequeiro-e-j%C3%A9ssica-horta-gomes/' },
      ...
      { type: 'talk', title: 'Porto Urban Greening Biennial', outlet: 'FCiências UP / Câmara Municipal do Porto (Bolsa MGAP)', year: '2024', url: 'https://mgaportugal.org/news-events/news/first-mgap-training-bursary' },
    ...
    volunteerItems: [
      { role: 'Consultora Hortícola', org: 'MGAP / APEJECM', period: '2020 – presente' },
      { role: 'Guia de Jardins', org: 'Jardins Abertos', period: '2021 – presente' },
